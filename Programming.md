...
type
`Job<'x>`[*](Hopac.html#def:type%20Hopac.Job),
...
`Ch<'x>`[*](Hopac.html#def:type%20Hopac.Ch),
and *alternatives*, represented by the type
`Alt<'x>`[*](Hopac.html#def:type%20Hopac.Alt),
...
* **Higher-order** means that primitive alternatives can be combined and
  extended[*](Hopac.html#def:val%20Hopac.Alt.Infixes.%3E%3E=?)
  with user defined procedures to
  build[*](Hopac.html#def:val%20Hopac.Alt.guard)
  more
  complex[*](Hopac.html#def:val%20Hopac.Alt.withNack)
  alternatives that encapsulate concurrent client-server protocols.
* **Selective** means that a form of
  choice[*](Hopac.html#def:val%20Hopac.Alt.choose)
  or disjunction between alternatives is supported.  An alternative can be
  constructed that, for example, offers to
  give[*](Hopac.html#def:val%20Hopac.Ch.Alt.give)
  a message to another job *or*
  take[*](Hopac.html#def:val%20Hopac.Ch.Alt.take)
...
job[*](Hopac.html#def:type%20Hopac.Job)
...
channels[*](Hopac.html#def:type%20Hopac.Ch):
...
job[*](Hopac.html#def:val%20Hopac.TopLevel.job)
that simply
gives[*](Hopac.html#def:val%20Hopac.Ch.give)
...
channel and then
takes[*](Hopac.html#def:val%20Hopac.Ch.take)
...
starts[*](Hopac.html#def:val%20Hopac.Job.start)
...
`result`[*](Hopac.html#def:val%20Hopac.Job.result)
and bind,
`>>=`[*](Hopac.html#def:val%20Hopac.Job.Infixes.%3E%3E=),
...
* There are many very commonly used monadic combinators,
  e.g. `|>>`[*](Hopac.html#def:val%20Hopac.Job.Infixes.|%3E%3E)
  and
  `>>%`[*](Hopac.html#def:val%20Hopac.Job.Infixes.%3E%3E%),
...
* Using the combinators directly I can often avoid some unnecessary
  `delay`[*](Hopac.html#def:val%20Hopac.Job.delay)
...
selective[*](Hopac.html#def:val%20Hopac.Alt.select)
communication.  It uses a
choice[*](Hopac.html#def:val%20Hopac.Alt.choose)
of two primitive
alternatives[*](Hopac.html#def:type%20Hopac.Alt):

* The first alternative
  takes[*](Hopac.html#def:val%20Hopac.Ch.Alt.take)
  a value on the `putCh` channel from a client and
  then[*](Hopac.html#def:val%20Hopac.Alt.Infixes.%3E%3E=?)
  loops.
* The second alternative
  gives[*](Hopac.html#def:val%20Hopac.Ch.Alt.take)
...
`iterate`[*](Hopac.html#def:val%20Hopac.Job.iterate)
...
`Job.server`[*](Hopac.html#def:val%20Hopac.Job.server)
instead of
`Job.start`[*](Hopac.html#def:val%20Hopac.Job.start).
...
picks[*](Hopac.html#def:val%20Hopac.Alt.pick)
...
selects[*](Hopac.html#def:val%20Hopac.Alt.select)
...
`timeOut`[*](Hopac.html#def:val%20Hopac.Timer.Global.timeOut)
...
`Promise`[*](Hopac.html#def:type%20Hopac.Promise)
...
alternative[*](Hopac.html#def:type%20Hopac.Alt)
mechanism:
...
`Job.conCollect`[*](Hopac.html#def:val%20Hopac.Job.conCollect)
and
`Job.conIgnore`[*](Hopac.html#def:val%20Hopac.Job.conIgnore)
...
`<&>`[*](Hopac.html#def:val%20Hopac.Job.Infixes.%3C&%3E)
and
`|>>`[*](Hopac.html#def:val%20Hopac.Job.Infixes.|%3E%3E)
...
`take`[*](Hopac.html#def:val%20Hopac.Ch.take)
and the
`give`[*](Hopac.html#def:val%20Hopac.Ch.give)
...
[*](Hopac.html#def:val%20Hopac.Alt.pick)
operation is used:
...
The `Alt.choose`
[*](Hopac.html#def:val%20Hopac.Alt.choose)
...
The wrap `>>=?`
[*](Hopac.html#def:val%20Hopac.Alt.Infixes.%3E%3E=?)
...
[*](Hopac.html#def:val%20Hopac.Alt.select)
and `<|>`
[*](Hopac.html#def:val%20Hopac.Alt.Infixes.%3C|%3E)
...
the `guard`
[*](Hopac.html#def:val%20Hopac.Alt.guard)
...
[*](Hopac.html#def:val%20Hopac.Timer.Global.timeOut)
...
[*](Hopac.html#def:val%20Hopac.Ch.send)
...
`withNack`
[*](Hopac.html#def:val%20Hopac.Alt.withNack)
combinator:
...
`Mailbox`[*](Hopac.html#def:type%20Hopac.Mailbox),
`IVar`[*](Hopac.html#def:type%20Hopac.IVar),
`MVar`[*](Hopac.html#def:type%20Hopac.MVar)
and
`Lock`[*](Hopac.html#def:type%20Hopac.Lock).
