...
[Hopac Library Reference](Hopac.html)
...
type
`Job<'x>`[&ast;](Hopac.html#def:type%20Hopac.Job),
...
`Ch<'x>`[&ast;](Hopac.html#def:type%20Hopac.Ch),
and *alternatives*, represented by the type
`Alt<'x>`[&ast;](Hopac.html#def:type%20Hopac.Alt),
...
* **Higher-order** means that primitive alternatives can be combined and
  extended[&ast;](Hopac.html#def:val%20Hopac.Alt.Infixes.%3E%3E=?)
  with user defined procedures to
  build[&ast;](Hopac.html#def:val%20Hopac.Alt.guard)
  more
  complex[&ast;](Hopac.html#def:val%20Hopac.Alt.withNack)
  alternatives that encapsulate concurrent client-server protocols.
* **Selective** means that a form of
  choice[&ast;](Hopac.html#def:val%20Hopac.Alt.choose)
  or disjunction between alternatives is supported.  An alternative can be
  constructed that, for example, offers to
  give[&ast;](Hopac.html#def:val%20Hopac.Ch.Alt.give)
  a message to another job *or*
  take[&ast;](Hopac.html#def:val%20Hopac.Ch.Alt.take)
...
job[&ast;](Hopac.html#def:type%20Hopac.Job)
...
channels[&ast;](Hopac.html#def:type%20Hopac.Ch):
...
job[&ast;](Hopac.html#def:val%20Hopac.TopLevel.job)
that simply
gives[&ast;](Hopac.html#def:val%20Hopac.Ch.give)
...
channel and then
takes[&ast;](Hopac.html#def:val%20Hopac.Ch.take)
...
starts[&ast;](Hopac.html#def:val%20Hopac.Job.start)
...
`result`[&ast;](Hopac.html#def:val%20Hopac.Job.result)
and bind,
`>>=`[&ast;](Hopac.html#def:val%20Hopac.Job.Infixes.%3E%3E=),
...
* There are many very commonly used monadic combinators,
  e.g. `|>>`[&ast;](Hopac.html#def:val%20Hopac.Job.Infixes.|%3E%3E)
  and
  `>>%`[&ast;](Hopac.html#def:val%20Hopac.Job.Infixes.%3E%3E%),
...
* Using the combinators directly I can often avoid some unnecessary
  `delay`[&ast;](Hopac.html#def:val%20Hopac.Job.delay)
...
selective[&ast;](Hopac.html#def:val%20Hopac.Alt.select)
communication.  It uses a
choice[&ast;](Hopac.html#def:val%20Hopac.Alt.choose)
of two primitive
alternatives[&ast;](Hopac.html#def:type%20Hopac.Alt):

* The first alternative
  takes[&ast;](Hopac.html#def:val%20Hopac.Ch.Alt.take)
  a value on the `putCh` channel from a client and
  then[&ast;](Hopac.html#def:val%20Hopac.Alt.Infixes.%3E%3E=?)
  loops.
* The second alternative
  gives[&ast;](Hopac.html#def:val%20Hopac.Ch.Alt.take)
...
`iterate`[&ast;](Hopac.html#def:val%20Hopac.Job.iterate)
...
`Job.server`[&ast;](Hopac.html#def:val%20Hopac.Job.server)
instead of
`Job.start`[&ast;](Hopac.html#def:val%20Hopac.Job.start).
...
picks[&ast;](Hopac.html#def:val%20Hopac.Alt.pick)
...
selects[&ast;](Hopac.html#def:val%20Hopac.Alt.select)
...
`timeOut`[&ast;](Hopac.html#def:val%20Hopac.Timer.Global.timeOut)
...
`Promise`[&ast;](Hopac.html#def:type%20Hopac.Promise)
...
alternative[&ast;](Hopac.html#def:type%20Hopac.Alt)
mechanism:
...
`Job.conCollect`[&ast;](Hopac.html#def:val%20Hopac.Job.conCollect)
and
`Job.conIgnore`[&ast;](Hopac.html#def:val%20Hopac.Job.conIgnore)
...
`<&>`[&ast;](Hopac.html#def:val%20Hopac.Job.Infixes.%3C&%3E)
and
`|>>`[&ast;](Hopac.html#def:val%20Hopac.Job.Infixes.|%3E%3E)
...
`take`[&ast;](Hopac.html#def:val%20Hopac.Ch.take)
and the
`give`[&ast;](Hopac.html#def:val%20Hopac.Ch.give)
...
[&ast;](Hopac.html#def:val%20Hopac.Alt.pick)
operation is used:
...
The `Alt.choose`
[&ast;](Hopac.html#def:val%20Hopac.Alt.choose)
...
The wrap `>>=?`
[&ast;](Hopac.html#def:val%20Hopac.Alt.Infixes.%3E%3E=?)
...
[&ast;](Hopac.html#def:val%20Hopac.Alt.select)
and `<|>`
[&ast;](Hopac.html#def:val%20Hopac.Alt.Infixes.%3C|%3E)
...
the `guard`
[&ast;](Hopac.html#def:val%20Hopac.Alt.guard)
...
[&ast;](Hopac.html#def:val%20Hopac.Timer.Global.timeOut)
...
[&ast;](Hopac.html#def:val%20Hopac.Ch.send)
...
`withNack`
[&ast;](Hopac.html#def:val%20Hopac.Alt.withNack)
combinator:
...
`Mailbox`[&ast;](Hopac.html#def:type%20Hopac.Mailbox),
`IVar`[&ast;](Hopac.html#def:type%20Hopac.IVar),
`MVar`[&ast;](Hopac.html#def:type%20Hopac.MVar)
and
`Lock`[&ast;](Hopac.html#def:type%20Hopac.Lock).
